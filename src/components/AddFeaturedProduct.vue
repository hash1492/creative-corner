        ...
        <div class="form-fields">
          <div class="input-fields">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" v-model="product.order">
            </div>
          </div>
...
export default {
  ...
  created: function () {
    ...
    if(this.$route.params.product_id) {
      this.editMode = true
      featuredCarouselCollection.where("id", "==", this.$route.params.product_id)
      .get()
  ...
  methods: {
    uploadImage: function (target, files) {
      ...
      var storageRef = firebaseStorage.ref('/featuredProductImages/' + selectedFile.name)
    ...
    addProduct() {
      ...
      var self = this;
      if(!this.product.description || !this.product.img || !this.product.link || !this.product.order) {
      ...
      featuredCarouselCollection.add(Object.assign({}, this.product))
    ...
    updateProduct() {
      ...
      featuredCarouselCollection.doc(this.product.firebaseId)
      .update(this.product)
      .then(function() {
